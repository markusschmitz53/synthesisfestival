...
function enqueue_assets() {
    wp_enqueue_style('stylesheet-voyage', get_template_directory_uri() . '/voyage-webfont.css');
    wp_register_script('mobile-navigation', get_template_directory_uri() . '/scripts/mobile-navigation.js', array(), '1.0', TRUE);
    ...
    wp_enqueue_style('stylesheet', get_template_directory_uri() . '/style-d893935.css');
